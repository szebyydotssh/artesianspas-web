...
const A8Page = () => {
  ...
  const product = products.find(p => p.name === 'A8');
    ...
    <div className={`min-h-screen bg-gradient-to-br from-slate-900 via-navy-900 to-ocean-900 pt-20 pb-8 transition-all duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        {Array.from({ length: 30 }).map((_, i) => (
          <div
            key={i}
            className="absolute w-3 h-3 bg-gradient-to-r from-ocean-400/20 to-teal-400/20 rounded-full animate-float"
            style={{
      ...
      {/* Custom cursor */}
      <div 
        className="fixed w-5 h-5 bg-gradient-to-r from-ocean-400/60 to-teal-400/60 rounded-full pointer-events-none z-50 mix-blend-difference transition-transform duration-100"
        style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative z-10 p-6 sm:p-8 md:p-12">
            <div className="max-w-2xl">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-4 animate-fade-in-up">
                {product.name}
                <span className="text-transparent bg-gradient-to-r from-ocean-400 to-teal-400 bg-clip-text">®</span>
              </h1>
              <div className="flex items-center space-x-4 mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-teal-400 font-semibold">Tágas Kényelem</span>
                </div>
              </div>
              <p className="text-xl text-white/80 mb-8 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                8 személyes spa nyitott elrendezéssel és lábterápiás kupolával - a tágas kényelem mércéje.
              </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
                {[
                  ...
                  { icon: Layout, label: 'Lounge', value: product.loungeSeats || 'Nincs' },
                  { icon: Zap, label: 'JetPak', value: product.jetpaks },
                  { icon: Waves, label: 'Szivattyú', value: product.therapyPumps }
                ].map((stat, index) => (
                  <div key={index} className="glass-card rounded-lg sm:rounded-xl p-3 sm:p-4 text-center hover:bg-white/10 transition-all duration-300 hover:scale-105 border border-teal-500/20">
                    <stat.icon className="w-5 h-5 sm:w-6 sm:h-6 text-teal-400 mx-auto mb-2" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className={`space-y-4 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            >
              ...
              {/* Premium Badge */}
              <div className="absolute top-4 right-4 glass-button px-3 py-1 rounded-full bg-gradient-to-r from-teal-500/20 to-ocean-500/20 border border-teal-400/30">
                <span className="text-teal-300 text-sm font-semibold">A Series® Multi-Trim</span>
              </div>
            </div>
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-900 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="glass-card rounded-2xl p-6 border border-teal-500/20">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-transparent bg-gradient-to-r from-teal-400 to-ocean-400 bg-clip-text font-semibold">A Széria® Tágas Spa</p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { label: 'Prémium JetPak® ülések', value: '4-6', icon: Zap },
                  { label: 'Lounge ülések', value: product.loungeSeats || 'Nincs', icon: Layout },
            ...
            <div className="space-y-4">
              <button className="w-full bg-gradient-to-r from-teal-500 to-ocean-500 text-white py-4 rounded-full font-semibold hover:from-teal-600 hover:to-ocean-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
            ...
            <div className="glass-card rounded-2xl p-6 border border-teal-500/20">
              ...
              <div className="space-y-3">
                {[
                  { label: 'Jelenlegi nézők', value: '18', trend: '+5' },
                  { label: 'Mai ajánlatkérések', value: '12', trend: '+6' },
                  { label: 'Foglalt bemutóterem látogatások', value: '8', trend: '+4' }
                ].map((stat, index) => (
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`flex-1 flex items-center justify-center space-x-2 py-3 px-4 rounded-full transition-all duration-300 ${
                  activeTab === tab.id
                    ? 'bg-gradient-to-r from-teal-500 to-ocean-500 text-white shadow-lg'
          ...
          <div className="glass-card rounded-3xl p-8 border border-teal-500/20">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                  {[
                    ...
                    <div key={index} className="text-center group">
                      <div className="bg-gradient-to-br from-teal-500/20 to-ocean-500/20 rounded-xl p-4 mb-2 group-hover:from-teal-500/30 group-hover:to-ocean-500/30 transition-all duration-300 border border-teal-400/20">
            ...
            {activeTab === 'features' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Prémium funkciók a tökéletes spa élményért minden A Series® szinten.
                </p>
            ...
            {activeTab === 'trims' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Az A8 három különböző szinten elérhető, mindegyik egyedi funkciókkal és testreszabási lehetőségekkel.
                </p>
                  ...
                  {product.trimLevels?.map((trim, index) => (
                    ...
                    >
                      <div className="text-center">
                        ...
                        <div className="space-y-3 text-left">
                          {index === 0 && (
                            <>
                              ...
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                                <span className="text-white/70">Prémium világítás</span>
                              </div>
                            </>
                          )}
                          {index === 1 && (
                            <>
                              ...
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                                <span className="text-white/70">Kibővített funkciók</span>
                              </div>
                            </>
                          )}
                          {index === 2 && (
                            <>
                              ...
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                                <span className="text-white/70">Prémium minőség</span>
                              </div>
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                        ...
                        <button className="w-full mt-4 bg-gradient-to-r from-teal-500/20 to-ocean-500/20 text-white py-2 rounded-lg font-semibold hover:from-teal-500/30 hover:to-ocean-500/30 transition-all duration-300 border border-teal-400/30">
        ...
        <div className="text-center">
          <div className="glass-card rounded-3xl p-12 relative overflow-hidden group border border-teal-500/20">
            {/* Animated background */}
            <div className="absolute inset-0 bg-gradient-to-r from-teal-500/10 via-ocean-500/10 to-navy-500/10 animate-gradient-shift"></div>
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div className="absolute inset-0 bg-gradient-to-r from-teal-500/20 via-ocean-500/20 to-navy-500/20"></div>
            </div>
            
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-6">
                <Grid3X3 className="w-8 h-8 text-teal-400 mr-3 animate-pulse" />
                <h2 className="text-4xl font-bold text-white">
                  Készen áll a tágas spa élményre?
                </h2>
                <Grid3X3 className="w-8 h-8 text-teal-400 ml-3 animate-pulse" />
              </div>
              
              <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
                Tapasztalja meg az A8 8 személyes spa-t - a tágas kényelem és személyre szabott terápia tökéletes kombinációja!
              </p>
              
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                <button className="bg-gradient-to-r from-teal-500 to-ocean-500 text-white px-8 py-4 rounded-full font-semibold hover:from-teal-600 hover:to-ocean-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Személyre szabott ajánlat</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                </button>
