...
const STIL7Page = () => {
  ...
  const product = products.find(p => p.name === 'STIL7');
  ...
  const tabs = [
    ...
    { id: 'design', label: 'Modern Design', icon: Palette },
    { id: 'trim', label: 'Trim Csomagok', icon: Layers }
  ];

  return (
    <div className={`min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-pink-900 pt-20 pb-8 transition-all duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      {/* Floating particles background */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        {Array.from({ length: 20 }).map((_, i) => (
          <div
            key={i}
            className="absolute w-3 h-3 bg-gradient-to-r from-purple-400/25 to-pink-400/25 rounded-full animate-float"
            style={{
      ...
      {/* Custom cursor */}
      <div 
        className="fixed w-5 h-5 bg-gradient-to-r from-purple-400/60 to-pink-400/60 rounded-full pointer-events-none z-50 mix-blend-difference transition-transform duration-100"
        style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        <div className={`flex items-center space-x-2 text-white/60 text-sm transition-all duration-700 delay-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <button onClick={() => navigate('/')} className="hover:text-purple-300 transition-all duration-300 hover:scale-105">
            Főoldal
          </button>
          <ChevronRight className="w-4 h-4 animate-pulse" />
          <button onClick={() => navigate('/products')} className="hover:text-purple-300 transition-all duration-300 hover:scale-105">
            Spa-k
          </button>
          <ChevronRight className="w-4 h-4 animate-pulse" />
          <span className="hover:text-purple-300 transition-all duration-300">STIL®</span>
          <ChevronRight className="w-4 h-4 animate-pulse" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative z-10 p-12">
            <div className="max-w-2xl">
              <h1 className="text-7xl font-bold text-white mb-4 animate-fade-in-up">
                {product.name}
                <span className="text-transparent bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text">®</span>
              </h1>
              <div className="flex items-center space-x-4 mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-purple-400 font-semibold">Modern Design</span>
                </div>
              </div>
              <p className="text-xl text-white/80 mb-8 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                Egyedülálló modern design esztétika - átgondoltan egyszerű, nyitott koncepció elegáns megjelenéssel.
              </p>
              ...
              <div className="grid grid-cols-4 gap-4 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
                {[
                  ...
                  { icon: Palette, label: 'Design', value: 'Modern' }
                ].map((stat, index) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className={`space-y-4 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            >
              ...
              {/* Premium Badge */}
              <div className="absolute top-4 right-4 glass-button px-3 py-1 rounded-full bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-400/30">
                <span className="text-purple-300 text-sm font-semibold">STIL® Design</span>
              </div>
            </div>
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-900 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="glass-card rounded-2xl p-6 border border-purple-500/20">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-transparent bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text font-semibold">STIL® Modern Design Spa</p>
                </div>
            ...
            <div className="glass-card rounded-2xl p-6 border border-purple-500/20">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="text-white font-semibold">Egyedülálló modern design</h4>
                    <p className="text-white/70 text-sm">Tiszta vonalak és modern esztétika, amely egyedülálló a mai piacon</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-pink-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Átgondolt nyitott koncepció</h4>
                    <p className="text-white/70 text-sm">Egyszerű, tágas elrendezés maximális kényelemért</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Kettős lounger elrendezés</h4>
                    <p className="text-white/70 text-sm">Minden ülés használható egyenes vagy relaxált dőlésszögben</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Ideális esztétikai középpont</h4>
                    <p className="text-white/70 text-sm">Tökéletes kiegészítője a jól megtervezett terasz környezetnek</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="max-h-48 overflow-y-auto space-y-2">
                {product.jetPakOptions?.map((jetpak, index) => (
                  ...
                  >
                    ...
                    <div className="text-xs mt-1 text-purple-400">{jetpak.jetCount} jet • {jetpak.targetAreas.join(', ')}</div>
                  </button>
                ))}
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {product.trimLevels?.map((trim, index) => (
                  ...
                  >
                    ...
                    <div className="text-sm mt-1">Részletek megtekintése</div>
                  </button>
                ))}
              </div>
            </div>
            ...
            {/* Action Buttons */}
            <div className="space-y-4">
              <button className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-4 rounded-full font-semibold hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
            ...
            <div className="glass-card rounded-2xl p-6 border border-purple-500/20">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { label: 'Mai ajánlatkérések', value: '8', trend: '+3' },
                  { label: 'STIL érdeklődések', value: '24', trend: '+9' }
                ].map((stat, index) => (
        ...
        <div className="mb-16">
          ...
          <div className="glass-card rounded-3xl p-8 border border-purple-500/20">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  {[
                    ...
                    <div key={index} className="text-center group">
                      <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-xl p-4 mb-2 group-hover:from-purple-500/30 group-hover:to-pink-500/30 transition-all duration-300 border border-purple-400/20">
            ...
            {activeTab === 'jetpaks' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  A JetPak Therapy System® forradalmi módszer a személyes spa tervezésére. Válassza ki a tökéletes masszázsokat, helyezze el őket kedvenc üléseiben, és bármikor frissítsen új JetPak®-kal.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {product.jetPakOptions?.map((jetpak, index) => (
                    <div key={index} className="glass-card rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 group border border-purple-500/10">
                      <div className="flex items-start space-x-3">
                        <Award className="w-6 h-6 text-purple-400 mt-1 flex-shrink-0 group-hover:scale-110 transition-transform" />
                        <div>
                          <h3 className="text-xl font-bold text-white mb-2 group-hover:text-purple-400 transition-colors">{jetpak.name}</h3>
            ...
            {activeTab === 'design' && (
              <div className="animate-fade-in">
                <h2 className="text-3xl font-bold text-white mb-6">Modern Design filozófia</h2>
                <p className="text-white/80 mb-8">
                  A STIL™ egyedülálló modern design esztétikát kínál tiszta vonalakkal és átgondolt elegenciával.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <div className="glass-card rounded-2xl p-6 border border-purple-500/10">
                      ...
                      <h3 className="text-xl font-bold text-white mb-3">Tiszta vonalak</h3>
                      <p className="text-white/70">Modern design esztétika, amely egyedülálló a mai spa piacon és bármely otthon megjelenését javítja.</p>
                    </div>
                    
                    <div className="glass-card rounded-2xl p-6 border border-pink-500/10">
                      <Lightbulb className="w-12 h-12 text-pink-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">Átgondolt elegancia</h3>
                      <p className="text-white/70">Visszafogott elegancia, amely tökéletesen illeszkedik modern építészeti és tájépítészeti tervekhez.</p>
                    </div>
                  </div>
                  
                  <div className="space-y-6">
                    <div className="glass-card rounded-2xl p-6 border border-blue-500/10">
                      <Compass className="w-12 h-12 text-blue-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">Nyitott koncepció</h3>
                      <p className="text-white/70">Átgondoltan egyszerű nyitott koncepció bőséges hellyel és maximális kényelemmel.</p>
                    </div>
                    
                    <div className="glass-card rounded-2xl p-6 border border-green-500/10">
                      <Minimize2 className="w-12 h-12 text-green-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">Esztétikai középpont</h3>
                      <p className="text-white/70">Ideális esztétikai középpont a jól megtervezett terasz környezetben és modern kertekben.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeTab === 'trim' && (
              <div className="animate-fade-in">
                <h2 className="text-3xl font-bold text-white mb-6">Trim csomagok összehasonlítása</h2>
                <p className="text-white/80 mb-8">
                  Válassza ki a megfelelő trim csomagot az igényeihez és költségvetéséhez.
                </p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {product.trimLevels?.map((trim, index) => (
                    <div key={index} className="glass-card rounded-2xl p-6 border border-purple-500/10 hover:bg-white/5 transition-all duration-300">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-2xl font-bold text-white">{trim}</h3>
                        <Layers className="w-8 h-8 text-purple-400" />
                      </div>
                      <div className="space-y-3">
                        <div className="flex items-center space-x-2">
                          <CheckCircle className="w-5 h-5 text-green-400" />
                          <span className="text-white/70">JetPak Therapy System®</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <CheckCircle className="w-5 h-5 text-green-400" />
                          <span className="text-white/70">Modern design elemek</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <CheckCircle className="w-5 h-5 text-green-400" />
                          <span className="text-white/70">Prémium érintővezérlők</span>
                        </div>
                        {index === 1 && (
                          <>
                            <div className="flex items-center space-x-2">
                              <CheckCircle className="w-5 h-5 text-purple-400" />
                              <span className="text-white/70">Fejlett világítási opciók</span>
                            </div>
                            <div className="flex items-center space-x-2">
                              <CheckCircle className="w-5 h-5 text-purple-400" />
                              <span className="text-white/70">Prémium hangrendszer</span>
                            </div>
                          </>
                        )}
                      </div>
                      <button className="w-full mt-6 bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-400/30 text-white py-3 rounded-full hover:from-purple-500/30 hover:to-pink-500/30 transition-all duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    ...
                    {[
                      ...
                      <div key={index} className="flex justify-between items-center p-3 glass-card rounded-lg border border-purple-500/10">
                    ...
                    {product.includedFeatures?.map((feature, index) => (
                      <div key={index} className="glass-card rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 group border border-purple-500/10">
                        <div className="flex items-start space-x-3">
                          ...
                          <div>
                            <h4 className="text-lg font-bold text-white mb-2 group-hover:text-purple-400 transition-colors">{feature.name}</h4>
        ...
        <div className="text-center">
          <div className="glass-card rounded-3xl p-12 relative overflow-hidden group border border-purple-500/20">
            <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 via-pink-500/10 to-purple-500/10 animate-gradient-shift"></div>
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-6">
                <Palette className="w-8 h-8 text-purple-400 mr-3 animate-pulse" />
                <h2 className="text-4xl font-bold text-white">
                  Készen áll a modern design élményre?
                </h2>
                <Lightbulb className="w-8 h-8 text-pink-400 ml-3 animate-pulse" />
              </div>
              
              <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
                Fedezze fel a STIL7-et - egyedülálló modern design és elegáns funkcionalitás!
              </p>
              
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                <button className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-4 rounded-full font-semibold hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">STIL Design Próba</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                </button>
                <button className="glass-button text-white px-8 py-4 rounded-full font-semibold hover:bg-white/20 transition-all duration-300 border border-white/30 hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Design Konzultáció</span>
