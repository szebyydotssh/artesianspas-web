...
const X7LPage = () => {
  ...
  const product = products.find(p => p.name === 'X7L');
  ...
  const tabs = [
    ...
    { id: 'design', label: 'Ergonómia', icon: Layers },
    ...
    <div className={`min-h-screen bg-gradient-to-br from-slate-900 via-navy-900 to-ocean-900 pt-20 pb-8 transition-all duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        {Array.from({ length: 20 }).map((_, i) => (
          <div
            key={i}
            className="absolute w-3 h-3 bg-gradient-to-r from-green-400/25 to-blue-400/25 rounded-full animate-float"
            style={{
      ...
      {/* Custom cursor */}
      <div 
        className="fixed w-5 h-5 bg-gradient-to-r from-green-400/60 to-blue-400/60 rounded-full pointer-events-none z-50 mix-blend-difference transition-transform duration-100"
        style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`relative mb-16 glass-card rounded-3xl overflow-hidden transition-all duration-1000 delay-500 ${isLoaded ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
          <div className="absolute inset-0 bg-gradient-to-r from-navy-900/80 via-transparent to-green-900/80 z-10"></div>
          ...
          <div className="relative z-10 p-12">
            <div className="max-w-2xl">
              <h1 className="text-7xl font-bold text-white mb-4 animate-fade-in-up">
                {product.name}
                <span className="text-transparent bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text">®</span>
              </h1>
              <div className="flex items-center space-x-4 mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-green-400 font-semibold">Ergonómia</span>
                </div>
              </div>
              <p className="text-xl text-white/80 mb-8 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                Változatos és kivételesen kényelmes kontúrök, ergonomikus dizájn - fejlett hidroterápia kevesebb helyen.
              </p>
              ...
              <div className="grid grid-cols-4 gap-4 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
                {[
                  ...
                  { icon: Layers, label: 'Ergonómia', value: 'TOP' },
                  { icon: Waves, label: 'Szivattyú', value: product.therapyPumps }
                ].map((stat, index) => (
                  <div key={index} className="glass-card rounded-xl p-4 text-center hover:bg-white/10 transition-all duration-300 hover:scale-105 border border-green-500/20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className={`space-y-4 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div 
              ref={imageRef}
              className="relative glass-card rounded-3xl overflow-hidden group cursor-zoom-in border border-green-500/20"
            ...
            >
              ...
              {/* 360° Indicator */}
              <div className="absolute top-4 left-4 glass-button px-3 py-1 rounded-full border border-green-400/30">
                <span className="text-white text-sm font-semibold">360°</span>
              </div>

              {/* Premium Badge */}
              <div className="absolute top-4 right-4 glass-button px-3 py-1 rounded-full bg-gradient-to-r from-green-500/20 to-blue-500/20 border border-green-400/30">
                <span className="text-green-300 text-sm font-semibold">X Series® Ergonómia</span>
              </div>
            </div>
              ...
              {product.images.map((image, index) => (
                <button
                  ...
                  className={`glass-card rounded-xl overflow-hidden border-2 transition-all duration-300 hover:scale-105 ${
                    selectedImage === index ? 'border-green-400 ring-2 ring-green-400/50' : 'border-transparent hover:border-white/30'
                  }`}
                >
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-900 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="glass-card rounded-2xl p-6 border border-green-500/20">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-transparent bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text font-semibold">X Széria® Ergonomikus Spa</p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={index} className="bg-white/5 rounded-xl p-4 hover:bg-white/10 transition-all duration-300 group border border-green-500/10">
                    <div className="flex items-center space-x-2 mb-2">
                      <item.icon className="w-4 h-4 text-green-400 group-hover:scale-110 transition-transform" />
            ...
            <div className="glass-card rounded-2xl p-6 border border-green-500/20">
              <h3 className="text-white font-semibold mb-4 flex items-center">
                ...
                Ergonomikus dizájn funkciók
              </h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Változatos kontúrök</h4>
                    <p className="text-white/70 text-sm">Kivételesen kényelmes kontúrök minden testméretre</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Jól megtervezett ülésrendszer</h4>
                    <p className="text-white/70 text-sm">Minden ülés optimális kényelemre és terápiára tervezve</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-yellow-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Fejlett hidroterápia</h4>
                    <p className="text-white/70 text-sm">Prémium spa élmény kevesebb helyen</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-purple-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Kompakt mégis tágas</h4>
                    <p className="text-white/70 text-sm">6 üléses minőség kevesebb helyen</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                {product.trimLevels?.map((trim, index) => (
                  ...
                  >
                    ...
                    <div className="text-sm mt-1">
                      {index === 0 && 'Prémium szűrés, érintőképernyős vezérlők, prémium világítási csomag, ergonomikus kényelem'}
                      {index === 1 && 'Alap szint kiváló ergonómiával és lounger funkcióval'}
                    </div>
                  </button>
                ))}
              </div>
            ...
            {/* Action Buttons */}
            <div className="space-y-4">
              <button className="w-full bg-gradient-to-r from-green-500 to-blue-500 text-white py-4 rounded-full font-semibold hover:from-green-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
                <span className="relative z-10">Ergonomikus Spa tervezése árazásért</span>
            ...
            <div className="glass-card rounded-2xl p-6 border border-green-500/20">
              ...
              <div className="space-y-3">
                {[
                  { label: 'Jelenlegi nézők', value: '14', trend: '+6' },
                  { label: 'Mai ajánlatkérések', value: '11', trend: '+4' },
                  { label: 'Ergonómia érdeklődések', value: '18', trend: '+9' }
                ].map((stat, index) => (
        ...
        <div className="mb-16">
          ...
          <div className="glass-card rounded-3xl p-8 border border-green-500/20">
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                  {[
                    ...
                    <div key={index} className="text-center group">
                      <div className="bg-gradient-to-br from-green-500/20 to-blue-500/20 rounded-xl p-4 mb-2 group-hover:from-green-500/30 group-hover:to-blue-500/30 transition-all duration-300 border border-green-400/20">
            ...
            {activeTab === 'design' && (
              <div className="animate-fade-in">
                <h2 className="text-3xl font-bold text-white mb-6">Ergonomikus dizájn</h2>
                <p className="text-white/80 mb-8">
                  Az X7L változatos és kivételesen kényelmes kontúrjai fejlett hidroterápiát biztosítanak kompakt méretben.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <div className="glass-card rounded-2xl p-6 border border-green-500/10">
                      ...
                      <h3 className="text-xl font-bold text-white mb-3">Változatos kontúrök</h3>
                      <p className="text-white/70">Kivételesen kényelmes kontúrök, amelyek minden testméretre optimálisan illeszkednek.</p>
                    </div>
                    
                    <div className="glass-card rounded-2xl p-6 border border-blue-500/10">
                      <Activity className="w-12 h-12 text-blue-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">Fejlett hidroterápia</h3>
                      <p className="text-white/70">Prémium minőségű hidroterápiás élmény, amely kevesebb helyet igényel.</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="glass-card rounded-2xl p-6 border border-yellow-500/10">
                      ...
                      <h3 className="text-xl font-bold text-white mb-3">Jól megtervezett ülésrendszer</h3>
                      <p className="text-white/70">Minden ülés optimális kényelemre és terápiára van tervezve ergonomikus elrendezéssel.</p>
                    </div>
                    
                    <div className="glass-card rounded-2xl p-6 border border-purple-500/10">
                      <Maximize2 className="w-12 h-12 text-purple-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">Kompakt mégis tágas</h3>
                      <p className="text-white/70">6 üléses minőség kevesebb helyen - tökéletes egyensúly a méret és funkcionalitás között.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="animate-fade-in">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {product.includedFeatures?.map((feature, index) => (
                    <div key={index} className="glass-card rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 group border border-green-500/10">
                      <div className="flex items-start space-x-3">
                        <CheckCircle className="w-6 h-6 text-green-400 mt-1 flex-shrink-0 group-hover:scale-110 transition-transform" />
                        <div>
                          <h3 className="text-xl font-bold text-white mb-2 group-hover:text-green-400 transition-colors">{feature.name}</h3>
            ...
            {activeTab === 'trims' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Az X7L két különböző szinten elérhető, mindegyik egyedi funkciókkal és ergonomikus kényelemmel.
                </p>
                        ...
                        <div className="space-y-3 text-left">
                          {index === 0 && (
                            <>
                              ...
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                                <span className="text-white/70">Ergonomikus kényelem</span>
                              </div>
                            </>
                          )}
                          {index === 1 && (
                            <>
                              ...
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                                <span className="text-white/70">Ergonomikus dizájn</span>
                              </div>
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                                <span className="text-white/70">Lounger ülés</span>
                              </div>
                            </>
                          )}
                        </div>
                        <button className="w-full mt-4 bg-gradient-to-r from-green-500/20 to-blue-500/20 text-white py-2 rounded-lg font-semibold hover:from-green-500/30 hover:to-blue-500/30 transition-all duration-300 border border-green-400/30">
        ...
        <div className="text-center">
          <div className="glass-card rounded-3xl p-12 relative overflow-hidden group border border-green-500/20">
            {/* Animated background */}
            <div className="absolute inset-0 bg-gradient-to-r from-green-500/10 via-blue-500/10 to-navy-500/10 animate-gradient-shift"></div>
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div className="absolute inset-0 bg-gradient-to-r from-green-500/20 via-blue-500/20 to-navy-500/20"></div>
            </div>
            
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-6">
                <Layers className="w-8 h-8 text-green-400 mr-3 animate-pulse" />
                <h2 className="text-4xl font-bold text-white">
                  Készen áll az ergonomikus spa élményre?
                </h2>
                <Target className="w-8 h-8 text-blue-400 ml-3 animate-pulse" />
              </div>
              
              <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
                Tapasztalja meg az X7L kivételesen kényelmes kontúrjait - fejlett hidroterápia kevesebb helyen, megfizethető X Series™ értéken!
              </p>
              
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                <button className="bg-gradient-to-r from-green-500 to-blue-500 text-white px-8 py-4 rounded-full font-semibold hover:from-green-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Ergonomikus Spa Próba</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                </button>
                <button className="glass-button text-white px-8 py-4 rounded-full font-semibold hover:bg-white/20 transition-all duration-300 border border-white/30 hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Kényelem Tesztelés</span>
