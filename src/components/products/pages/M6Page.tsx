...
const M6Page = () => {
  ...
  const product = products.find(p => p.name === 'M6');
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex items-center space-x-4 mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-yellow-400">Kompakt Kiválóság</span>
                </div>
              </div>
              <p className="text-xl text-white/80 mb-8 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                Prémium szintű, helytakarékos spa - erős terápia két terápiás szivattyúval kis helyen.
              </p>
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-900 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="glass-card rounded-2xl p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-ocean-400 font-semibold">M Széria® Kompakt</p>
                </div>
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              <div className="space-y-3">
                {[
                  { label: 'Jelenlegi nézők', value: '4', trend: '+1' },
                  { label: 'Mai ajánlatkérések', value: '7', trend: '+3' },
                  { label: 'Foglalt bemutóterem látogatások', value: '3', trend: '+2' }
                ].map((stat, index) => (
