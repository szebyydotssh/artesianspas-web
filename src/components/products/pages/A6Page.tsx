...
const A6Page = () => {
  ...
  const product = products.find(p => p.name === 'A6');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex items-center space-x-4 mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-teal-400 font-semibold">Helytakarékos</span>
                </div>
              </div>
              <p className="text-xl text-white/80 mb-8 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                Prémium helytakarékos spa - kis külső lábnyom, bőséges belső tér városi életstílushoz.
              </p>
              ...
              <div className="grid grid-cols-4 gap-4 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
                {[
                  ...
                  { icon: Home, label: 'Sarok Ülés', value: '4x' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className={`space-y-4 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            >
              ...
              <div className="absolute top-4 right-4 glass-button px-3 py-1 rounded-full bg-gradient-to-r from-teal-500/20 to-blue-500/20 border border-teal-400/30">
                <span className="text-teal-300 text-sm font-semibold">A Series® Compact</span>
              </div>
            </div>
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-900 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="glass-card rounded-2xl p-6 border border-teal-500/20">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-transparent bg-gradient-to-r from-teal-400 to-blue-400 bg-clip-text font-semibold">A Széria® Prémium Helytakarékos Spa</p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { label: 'Prémium JetPak® ülések', value: '3-4', icon: Zap },
            ...
            {/* Corner Seats Features */}
            <div className="glass-card rounded-2xl p-6 border border-teal-500/20">
              <h3 className="text-white font-semibold mb-4 flex items-center">
                <Home className="w-5 h-5 text-teal-400 mr-2" />
                Négy prémium sarok ülés
              </h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-teal-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Egyedi masszázs élmény</h4>
                    <p className="text-white/70 text-sm">Minden sarok ülés egyedi masszázst kínál személyre szabható JetPak® opcióval</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Optimális helyfelhasználás</h4>
                    <p className="text-white/70 text-sm">Intelligens sarok elrendezés maximális kényelem kis helyigénnyel</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-cyan-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Nyitott központi tér</h4>
                    <p className="text-white/70 text-sm">Bőséges központi tér a kinyújtózáshoz és relaxáláshoz</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Tökéletes spa élmény tervezés</h4>
                    <p className="text-white/70 text-sm">Lehetővé teszi a személyre szabott terápiás élmény megteremtését</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card rounded-2xl p-6 border border-teal-500/20">
              ...
              <div className="space-y-3">
                {[
                  { label: 'Jelenlegi nézők', value: '18', trend: '+8' },
                  { label: 'Mai ajánlatkérések', value: '14', trend: '+9' },
                  { label: 'Foglalt bemutóterem látogatások', value: '9', trend: '+5' }
                ].map((stat, index) => (
          ...
          <div className="glass-card rounded-3xl p-8 border border-teal-500/20">
              ...
              <div className="animate-fade-in">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {product.jetPakOptions?.map((jetPak, index) => (
                    <div 
                      key={index} 
                      className="glass-card rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 cursor-pointer group hover:scale-105 border border-teal-500/10"
                      onClick={() => setSelectedJetPak(index)}
                    >
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-xl font-bold text-white group-hover:text-teal-400 transition-colors">{jetPak.name}</h3>
                        <Zap className="w-5 h-5 text-teal-400 group-hover:animate-pulse" />
                      </div>
                        ...
                        <div className="mt-3">
                          ...
                          <div className="flex flex-wrap gap-2 mt-2">
                            {jetPak.targetAreas.map((area, i) => (
                              <span key={i} className="bg-teal-500/20 text-teal-300 px-2 py-1 rounded-full text-xs border border-teal-400/30">
                                {area}
                              </span>
                            ))}
                          </div>
            ...
            {activeTab === 'features' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Prémium funkciók a tökéletes spa élményért minden A Series® szinten, különös hangsúllyal a helytakarékos dizájnra és városi kompatibilitásra.
                </p>
            ...
            {activeTab === 'trims' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Az A6 három különböző szinten elérhető, mindegyik egyedi funkciókkal és testreszabási lehetőségekkel.
                </p>
                  ...
                  {product.trimLevels?.map((trim, index) => (
                    ...
                    >
                      <div className="text-center">
                        ...
                        <div className="space-y-3 text-left">
                          {index === 0 && (
                            <>
                              ...
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                                <span className="text-white/70">Prémium sarok ülések</span>
                              </div>
                            </>
                          )}
                          {index === 1 && (
                            <>
                              ...
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                                <span className="text-white/70">Helytakarékos prémium</span>
                              </div>
                            </>
                          )}
                          {index === 2 && (
                            <>
                              ...
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                                <span className="text-white/70">Városi kompatibilis</span>
                              </div>
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                        ...
                        <button className="w-full mt-4 bg-gradient-to-r from-teal-500/20 to-blue-500/20 text-white py-2 rounded-lg font-semibold hover:from-teal-500/30 hover:to-blue-500/30 transition-all duration-300 border border-teal-400/30">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-6">
                ...
                <h2 className="text-4xl font-bold text-white">
                  Készen áll a helytakarékos luxusra?
                </h2>
                <Home className="w-8 h-8 text-blue-400 ml-3 animate-pulse" />
              </div>
              
              <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
                Tapasztalja meg az A6 prémium helytakarékos dizájnját - kis külső lábnyom, nagy belső élmény városi környezetben!
              </p>
              ...
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                <button className="bg-gradient-to-r from-teal-500 to-blue-500 text-white px-8 py-4 rounded-full font-semibold hover:from-teal-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Helytakarékos spa ajánlat</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                </button>
                <button className="glass-button text-white px-8 py-4 rounded-full font-semibold hover:bg-white/20 transition-all duration-300 border border-white/30 hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Sarok ülés próba</span>
              ...
              <div className="flex items-center justify-center space-x-8 mt-8 text-white/60">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span>Helytakarékos dizájn</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Home className="w-5 h-5 text-blue-400" />
                  <span>Városi kompatibilis</span>
                </div>
              </div>
            </div>
          </div>
