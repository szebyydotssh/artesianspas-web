...
const M8Page = () => {
  ...
  const product = products.find(p => p.name === 'M8');
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex items-center space-x-4 mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-yellow-400">Kompakt Elegancia</span>
                </div>
              </div>
              <p className="text-xl text-white/80 mb-8 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                Fedezze fel az innovatív kettős lounge ülést és a legflexibilisebb ülésrendszert ebben a méretű spa kategóriában.
              </p>
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-900 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              <div className="space-y-3">
                {[
                  { label: 'Jelenlegi nézők', value: '8', trend: '+1' },
                  { label: 'Mai ajánlatkérések', value: '5', trend: '+2' },
                  { label: 'Foglalt bemutóterem látogatások', value: '3', trend: '+1' }
                ].map((stat, index) => (
