...
const A6LPage = () => {
  ...
  const product = products.find(p => p.name === 'A6L');
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex items-center space-x-4 mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-cyan-400 font-semibold">Városi Kedvenc</span>
                </div>
              </div>
              <p className="text-xl text-white/80 mb-8 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                Kis spa nagy funkcionalitással - népszerű egyedülállók, városlakók és kis családok számára.
              </p>
              
              {/* Quick Stats */}
              <div className="grid grid-cols-4 gap-4 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
                {[
                  { icon: Users, label: 'Ülőhely', value: '4-6' },
          ...
          <div className={`space-y-4 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            >
              ...
              <div className="absolute top-4 right-4 glass-button px-3 py-1 rounded-full bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border border-cyan-400/30">
                <span className="text-cyan-300 text-sm font-semibold">A Series® Kompakt</span>
              </div>
            </div>
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-900 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="glass-card rounded-2xl p-6 border border-cyan-500/20">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-transparent bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text font-semibold">A Széria® Kompakt Luxus Spa</p>
                </div>
            ...
            <div className="glass-card rounded-2xl p-6 border border-cyan-500/20">
              <h3 className="text-white font-semibold mb-4 flex items-center">
                ...
                Városi életstílus optimalizálás
              </h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-cyan-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Egyedülállók számára</h4>
                    <p className="text-white/70 text-sm">Tökéletes méret és funkcionalitás egyedülálló felhasználók számára</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Városlakók kedvence</h4>
                    <p className="text-white/70 text-sm">Kis külső lábnyom, nagy belső funkcionaltás városi környezethez</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Kis családok számára</h4>
                    <p className="text-white/70 text-sm">4 felnőtt kényelmes elhelyezése, akár 6 személy befogadása</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-purple-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Univerzális kompatibilitás</h4>
                    <p className="text-white/70 text-sm">Elfér a legtöbb fedélzeten, erkélyen és teraszon</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                {product.trimLevels?.map((trim, index) => (
                  ...
                  >
                    ...
                    <div className="text-sm mt-1">
                      {index === 0 && '4 JetPak®, 3-funkciós vezérlők, prémium világítás'}
                      {index === 1 && '3 JetPak®, Luxury Package kibővített funkciókkal'}
                      {index === 2 && '3 JetPak®, alap szint kiváló ár-érték aránnyal'}
                    </div>
                  </button>
                ))}
              </div>
            ...
            <div className="glass-card rounded-2xl p-6 border border-cyan-500/20">
              ...
              <div className="space-y-3">
                {[
                  { label: 'Jelenlegi nézők', value: '42', trend: '+16' },
                  { label: 'Mai ajánlatkérések', value: '31', trend: '+18' },
                  { label: 'Foglalt bemutóterem látogatások', value: '23', trend: '+14' }
                ].map((stat, index) => (
          ...
          <div className="glass-card rounded-3xl p-8 border border-cyan-500/20">
              ...
              <div className="animate-fade-in">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {product.jetPakOptions?.map((jetPak, index) => (
                    <div 
                      key={index} 
                      className="glass-card rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 cursor-pointer group hover:scale-105 border border-cyan-500/10"
                      onClick={() => setSelectedJetPak(index)}
                    >
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-xl font-bold text-white group-hover:text-cyan-400 transition-colors">{jetPak.name}</h3>
                        ...
                        <div className="mt-3">
                          ...
                          <div className="flex flex-wrap gap-2 mt-2">
                            {jetPak.targetAreas.map((area, i) => (
                              <span key={i} className="bg-cyan-500/20 text-cyan-300 px-2 py-1 rounded-full text-xs border border-cyan-400/30">
                                {area}
                              </span>
                            ))}
                          </div>
            ...
            {activeTab === 'features' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Prémium funkciók a tökéletes spa élményért minden A Series® szinten, különös hangsúllyal a kompakt dizájnra és városi kompatibilitásra.
                </p>
                  ...
                  {product.includedFeatures?.map((feature, index) => (
                    <div key={index} className="glass-card rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 group border border-cyan-500/10">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h3 className="text-xl font-bold text-white mb-2 group-hover:text-cyan-400 transition-colors">{feature.name}</h3>
            ...
            {activeTab === 'trims' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Az A6L három különböző szinten elérhető, mindegyik egyedi funkciókkal és testreszabási lehetőségekkel.
                </p>
                  ...
                  {product.trimLevels?.map((trim, index) => (
                    ...
                    >
                      <div className="text-center">
                          ...
                          {index === 0 && (
                            <>
                              <div className="flex items-center space-x-2">
                                ...
                                <span className="text-white/70">4 JetPak® ülés</span>
                              </div>
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                        ...
                        <button className="w-full mt-4 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 text-white py-2 rounded-lg font-semibold hover:from-cyan-500/30 hover:to-blue-500/30 transition-all duration-300 border border-cyan-400/30">
          ...
          <div className="glass-card rounded-3xl p-12 relative overflow-hidden group border border-cyan-500/20">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-6">
                <Building2 className="w-8 h-8 text-cyan-400 mr-3 animate-pulse" />
                <h2 className="text-4xl font-bold text-white">
                  Készen áll a városi spa élményre?
                </h2>
                <UserCheck className="w-8 h-8 text-blue-400 ml-3 animate-pulse" />
              </div>
              
              <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
                Tapasztalja meg az A6L kompakt luxusát - kis spa nagy funkcionalitással városi életstílushoz!
              </p>
              ...
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                <button className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-8 py-4 rounded-full font-semibold hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Kompakt spa ajánlat</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                </button>
                <button className="glass-button text-white px-8 py-4 rounded-full font-semibold hover:bg-white/20 transition-all duration-300 border border-white/30 hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Városi próba</span>
              ...
              <div className="flex items-center justify-center space-x-8 mt-8 text-white/60">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span>Városi optimalizálás</span>
                </div>
                <div className="flex items-center space-x-2">
                  <UserCheck className="w-5 h-5 text-blue-400" />
                  <span>4-6 személyes</span>
                </div>
              </div>
            </div>
          </div>
