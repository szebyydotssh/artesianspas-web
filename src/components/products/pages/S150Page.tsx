...
const S150Page = () => {
  ...
  const product = products.find(p => p.name === 'S150');
  ...
  const tabs = [
    ...
    { id: 'capacity', label: '13 Személyes', icon: Users2 }
  ];
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-slate-900 via-navy-900 to-ocean-900 pt-20 pb-8 transition-all duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex items-center space-x-4 mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-cyan-400 font-semibold">13 Személyes</span>
                </div>
              </div>
              <p className="text-xl text-white/80 mb-8 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                A legnagyobb Swim Series™ modell - 13 ülőhellyel és fejlett hátsókert vízi élménnyel.
              </p>
              ...
              <div className="grid grid-cols-4 gap-4 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
                {[
                  ...
                  { icon: Activity, label: 'Úszás', value: 'OK' },
          ...
          <div className={`space-y-4 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            >
              ...
              <div className="absolute top-4 right-4 glass-button px-3 py-1 rounded-full bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border border-cyan-400/30">
                <span className="text-cyan-300 text-sm font-semibold">Legnagyobb Modell</span>
              </div>
            </div>
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-900 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="glass-card rounded-2xl p-6 border border-cyan-500/20">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-transparent bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text font-semibold">Swim Series™ Legnagyobb Modell</p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { label: 'Úszóáram rendszer', value: 'Egyedi', icon: Activity },
            ...
            <div className="glass-card rounded-2xl p-6 border border-cyan-500/20">
              <h3 className="text-white font-semibold mb-4 flex items-center">
                <Users2 className="w-5 h-5 text-cyan-400 mr-2" />
                13 személyes előnyök
              </h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-cyan-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Legnagyobb Swim Series™ modell</h4>
                    <p className="text-white/70 text-sm">13 ülőhellyel a legbőségesebb hely az egész család számára</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Fejlett hátsókert élmény</h4>
                    <p className="text-white/70 text-sm">Állóképesség építés, erő fejlesztés és családi szórakozás egyben</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Rendkívül funkcionális elrendezés</h4>
                    <p className="text-white/70 text-sm">Végtelen használati lehetőségekre tervezett funkciók</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-yellow-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Hagyományos Bullfrog minőség</h4>
                    <p className="text-white/70 text-sm">Megbízhatóság, vonzó esztétika és prémium funkcionalitás</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <button className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white py-4 rounded-full font-semibold hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
                <span className="relative z-10">Legnagyobb Spa tervezése árazásért</span>
            ...
            <div className="glass-card rounded-2xl p-6 border border-cyan-500/20">
              ...
              <div className="space-y-3">
                {[
                  { label: 'Jelenlegi nézők', value: '31', trend: '+14' },
                  { label: 'Mai ajánlatkérések', value: '18', trend: '+7' },
                  { label: 'Nagy spa érdeklődések', value: '45', trend: '+18' }
                ].map((stat, index) => (
        ...
        <div className="mb-16">
          <div className="flex space-x-1 mb-8 glass-card rounded-full p-2 max-w-3xl mx-auto border border-cyan-500/20">
            {tabs.map((tab) => (
              <button
                key={tab.id}
          ...
          <div className="glass-card rounded-3xl p-8 border border-cyan-500/20">
            ...
            {activeTab === 'capacity' && (
              <div className="animate-fade-in">
                <h2 className="text-3xl font-bold text-white mb-6">13 személyes kapacitás előnyei</h2>
                <p className="text-white/80 mb-8">
                  Az S150 a legnagyobb Swim Series™ modell, amely 13 ülőhellyel bőséges helyet biztosít mindenki számára.
                </p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <div className="glass-card rounded-2xl p-6 border border-cyan-500/10">
                      <Users2 className="w-12 h-12 text-cyan-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">13 ülőhely</h3>
                      <p className="text-white/70">A legnagyobb Swim Series™ modell, amely bőséges helyet biztosít az egész család számára.</p>
                    </div>
                    
                    <div className="glass-card rounded-2xl p-6 border border-blue-500/10">
                      <Gamepad2 className="w-12 h-12 text-blue-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">Családi szórakozás</h3>
                      <p className="text-white/70">Tágas Splash Zone, ahol mindenki egyidejűleg játszhat, úszkálhat és szórakozhat.</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="glass-card rounded-2xl p-6 border border-green-500/10">
                      ...
                      <h3 className="text-xl font-bold text-white mb-3">Prémium élmény</h3>
                      <p className="text-white/70">Hagyományos Bullfrog Spas minőség és megbízhatóság a legnagyobb formátumban.</p>
                    </div>
                    
                    <div className="glass-card rounded-2xl p-6 border border-yellow-500/10">
                      <Maximize2 className="w-12 h-12 text-yellow-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">Funkcionális elrendezés</h3>
                      <p className="text-white/70">Rendkívül funkcionális elrendezés végtelen használati lehetőségekkel.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeTab === 'jetpaks' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Az S150 egyedülálló JetPak Therapy System™-mel rendelkezik 16+ cserélhető masszázs opcióval.
                </p>
            ...
            {activeTab === 'swim' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Az S150 állóképesség építésre és erő fejlesztésre tervezett funkciókkal rendelkezik.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <div className="glass-card rounded-2xl p-6 border border-cyan-500/10">
                      ...
                      <p className="text-white/70">Anatómiailag hangolt úszóáram rendszer könnyebb és hatékonyabb úszásért.</p>
                    </div>
                    
                    <div className="glass-card rounded-2xl p-6 border border-blue-500/10">
                      <Dumbbell className="w-12 h-12 text-blue-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">Állóképesség és erő</h3>
                      <p className="text-white/70">Előre beállított vagy testreszabható fitnesz programok és ellenállásos edzés.</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="glass-card rounded-2xl p-6 border border-green-500/10">
                      ...
                      <h3 className="text-xl font-bold text-white mb-3">Alacsony hatású edzés</h3>
                      <p className="text-white/70">Hely bármilyen számú alacsony hatású, vízi edzéshez egész évben.</p>
                    </div>
                    
                    <div className="glass-card rounded-2xl p-6 border border-yellow-500/10">
                      <Crown className="w-12 h-12 text-yellow-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">Multifunkciós használat</h3>
                      <p className="text-white/70">Dolgozzon, játsszon vagy relaxáljon feszültségoldás céljából saját hátsókertjében.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="glass-card rounded-3xl p-12 relative overflow-hidden group border border-cyan-500/20">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-6">
                <Users2 className="w-8 h-8 text-cyan-400 mr-3 animate-pulse" />
                <h2 className="text-4xl font-bold text-white">
                  Készen áll a legnagyobb élményre?
                </h2>
                <Crown className="w-8 h-8 text-blue-400 ml-3 animate-pulse" />
              </div>
              
              <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
                Fedezze fel az S150-t - a legnagyobb Swim Series™ modellt 13 ülőhellyel!
              </p>
              ...
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                <button className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-8 py-4 rounded-full font-semibold hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Legnagyobb Spa Próba</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                </button>
                <button className="glass-button text-white px-8 py-4 rounded-full font-semibold hover:bg-white/20 transition-all duration-300 border border-white/30 hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Családi Spa Teszt</span>
              ...
              <div className="flex items-center justify-center space-x-8 mt-8 text-white/60">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span>13 Személyes</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Star className="w-5 h-5 text-yellow-400 fill-current" />
                  <span>5.0 értékelés</span>
                </div>
              </div>
            </div>
          </div>
