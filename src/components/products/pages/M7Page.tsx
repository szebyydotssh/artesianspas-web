...
const M7Page = () => {
  ...
  const product = products.find(p => p.name === 'M7');
    ...
    <div className={`min-h-screen bg-gradient-to-br from-slate-900 via-navy-900 to-ocean-900 pt-20 pb-8 transition-all duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        {Array.from({ length: 20 }).map((_, i) => (
          <div
            key={i}
            className="absolute w-2 h-2 bg-ocean-400/20 rounded-full animate-float"
            style={{
      ...
      {/* Custom cursor */}
      <div 
        className="fixed w-4 h-4 bg-ocean-400/50 rounded-full pointer-events-none z-50 mix-blend-difference transition-transform duration-100"
        style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        <div className={`flex flex-wrap items-center gap-2 text-white/60 text-xs sm:text-sm transition-all duration-700 delay-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          <ChevronRight className="w-4 h-4 animate-pulse" />
          <span className="hover:text-ocean-300 transition-all duration-300">M Széria®</span>
          <ChevronRight className="w-4 h-4 animate-pulse" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex items-center space-x-4 mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-yellow-400">Adirondack Inspiráció</span>
                </div>
              </div>
              <p className="text-xl text-white/80 mb-8 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                Élvezze az Adirondack-stílusú prémium terápiás üléseket és a kettős JetPak® szerelmes ülést.
              </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className={`space-y-4 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div 
              ref={imageRef}
              className="relative glass-card rounded-3xl overflow-hidden group cursor-zoom-in"
            ...
            >
              ...
              {/* 360° Indicator */}
              <div className="absolute top-4 left-4 glass-button px-3 py-1 rounded-full">
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-900 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="glass-card rounded-2xl p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-ocean-400 font-semibold">M Széria® Középméret</p>
                </div>
                ...
                {[
                  ...
                  <div key={index} className="bg-white/5 rounded-xl p-4 hover:bg-white/10 transition-all duration-300 group">
                    <div className="flex items-center space-x-2 mb-2">
                      <item.icon className="w-4 h-4 text-ocean-400 group-hover:scale-110 transition-transform" />
            ...
            <div className="space-y-4">
              <button className="w-full bg-gradient-to-r from-ocean-500 to-navy-500 text-white py-4 rounded-full font-semibold hover:from-ocean-600 hover:to-navy-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
            ...
            <div className="glass-card rounded-2xl p-6">
              ...
              <div className="space-y-3">
                {[
                  { label: 'Jelenlegi nézők', value: '6', trend: '+1' },
                  { label: 'Mai ajánlatkérések', value: '4', trend: '+2' },
                  { label: 'Foglalt bemutóterem látogatások', value: '2', trend: '+1' }
                ].map((stat, index) => (
        ...
        <div className="text-center">
          <div className="glass-card rounded-3xl p-12 relative overflow-hidden group">
            ...
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div className="absolute inset-0 bg-gradient-to-r from-ocean-500/20 via-navy-500/20 to-purple-500/20"></div>
            </div>
