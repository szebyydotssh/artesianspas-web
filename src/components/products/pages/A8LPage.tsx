...
const A8LPage = () => {
  ...
  const product = products.find(p => p.name === 'A8L');
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex items-center space-x-4 mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-purple-400 font-semibold">Változatos Relaxáció</span>
                </div>
              </div>
              <p className="text-xl text-white/80 mb-8 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                7 személyes terápiás spa prémium lounger-rel és kapitány székkel - minden ülésben más élmény.
              </p>
          ...
          <div className={`space-y-4 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            >
              ...
              <div className="absolute top-4 right-4 glass-button px-3 py-1 rounded-full bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-purple-400/30">
                <span className="text-purple-300 text-sm font-semibold">A Series® Lounger</span>
              </div>
            </div>
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-900 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="glass-card rounded-2xl p-6 border border-purple-500/20">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-transparent bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text font-semibold">A Széria® Terápiás Lounger Spa</p>
                </div>
            ...
            <div className="glass-card rounded-2xl p-6 border border-purple-500/20">
              <h3 className="text-white font-semibold mb-4 flex items-center">
                <Armchair className="w-5 h-5 text-purple-400 mr-2" />
                Egyedi üléslehetőségek
              </h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-sm">Ergonomikus tervezés teljes testhosszúságú relaxációhoz</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Terápiás sarok kapitány szék</h4>
                    <p className="text-white/70 text-sm">Célzott terápia és kiváló kilátás a spa-ra</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Változatos terápiás ülések</h4>
                    <p className="text-white/70 text-sm">Minden ülésben más hidroterápiás élmény</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card rounded-2xl p-6 border border-purple-500/20">
              ...
              <div className="space-y-3">
                {[
                  { label: 'Jelenlegi nézők', value: '22', trend: '+7' },
                  { label: 'Mai ajánlatkérések', value: '15', trend: '+8' },
                  { label: 'Foglalt bemutóterem látogatások', value: '11', trend: '+6' }
                ].map((stat, index) => (
          ...
          <div className="glass-card rounded-3xl p-8 border border-purple-500/20">
            ...
            {activeTab === 'features' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Prémium funkciók a tökéletes spa élményért minden A Series® szinten, különös hangsúllyal a változatos üléslehetőségekre.
                </p>
            ...
            {activeTab === 'trims' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Az A8L három különböző szinten elérhető, mindegyik egyedi funkciókkal és testreszabási lehetőségekkel.
                </p>
                        ...
                        <div className="space-y-3 text-left">
                          ...
                          {index === 1 && (
                            <>
                              ...
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                                <span className="text-white/70">Kibővített ülés funkciók</span>
                              </div>
                            </>
                          )}
                          {index === 2 && (
                            <>
                              ...
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                                <span className="text-white/70">Prémium ülésrendszer</span>
                              </div>
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
          ...
          <div className="glass-card rounded-3xl p-12 relative overflow-hidden group border border-purple-500/20">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-6">
                <Armchair className="w-8 h-8 text-purple-400 mr-3 animate-pulse" />
                <h2 className="text-4xl font-bold text-white">
                  Készen áll a változatos relaxációra?
                </h2>
                <Users2 className="w-8 h-8 text-blue-400 ml-3 animate-pulse" />
              </div>
              
              <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
                Tapasztalja meg az A8L különleges üléslehetőségeit - minden helyen más hidroterápiás élmény várja!
              </p>
              ...
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                <button className="bg-gradient-to-r from-purple-500 to-blue-500 text-white px-8 py-4 rounded-full font-semibold hover:from-purple-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Terápiás spa ajánlat</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                </button>
