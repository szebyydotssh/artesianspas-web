...
const S200Page = () => {
  ...
  const product = products.find(p => p.name === 'S200');
  ...
  const tabs = [
    ...
    { id: 'family', label: 'Családi Szórakozás', icon: Gamepad2 }
  ];
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex items-center space-x-4 mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-blue-400 font-semibold">Úszás & Spa</span>
                </div>
              </div>
              <p className="text-xl text-white/80 mb-8 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                Multifunkciós hátsókert vízi élmény - úszás, fitnesz, terápia és családi szórakozás egyben.
              </p>
          ...
          <div className={`space-y-4 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            >
              ...
              <div className="absolute top-4 right-4 glass-button px-3 py-1 rounded-full bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border border-cyan-400/30">
                <span className="text-cyan-300 text-sm font-semibold">Swim Series™</span>
              </div>
            </div>
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-900 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="glass-card rounded-2xl p-6 border border-cyan-500/20">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-transparent bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text font-semibold">Swim Series™ Multifunkciós Spa</p>
                </div>
            ...
            <div className="glass-card rounded-2xl p-6 border border-cyan-500/20">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="text-white font-semibold">Egyedi úszóáram rendszer</h4>
                    <p className="text-white/70 text-sm">Anatómiailag hangolt áram segít a testet vízszintesen tartani könnyebb úszásért</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">JetPak Therapy System™</h4>
                    <p className="text-white/70 text-sm">Egyedülálló cserélhető JetPak masszázsok személyre szabható terápiáért</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Splash Zone játékterület</h4>
                    <p className="text-white/70 text-sm">Tágas terület családi szórakozáshoz és vízi játékokhoz</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-yellow-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Multifunkciós élmény</h4>
                    <p className="text-white/70 text-sm">Úszás, fitnesz, terápia és családi szórakozás egyben</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <button className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white py-4 rounded-full font-semibold hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
                <span className="relative z-10">Swim Spa tervezése árazásért</span>
            ...
            <div className="glass-card rounded-2xl p-6 border border-cyan-500/20">
              ...
              <div className="space-y-3">
                {[
                  { label: 'Jelenlegi nézők', value: '23', trend: '+8' },
                  { label: 'Mai ajánlatkérések', value: '12', trend: '+5' },
                  { label: 'Swim spa érdeklődések', value: '34', trend: '+12' }
                ].map((stat, index) => (
          ...
          <div className="glass-card rounded-3xl p-8 border border-cyan-500/20">
            ...
            {activeTab === 'jetpaks' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Az egyetlen Swim Series™ spa az egyedülálló JetPak Therapy System™-mel. Válassza ki a tökéletes masszázsokat, helyezze el őket kedvenc üléseiben, és bármikor frissítsen új JetPak®-kal.
                </p>
            ...
            {activeTab === 'swim' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Az S200 Swim Series™ spa egyedülálló úszóáram rendszerrel és fitnesz lehetőségekkel rendelkezik.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <div className="glass-card rounded-2xl p-6 border border-cyan-500/10">
                      ...
                      <p className="text-white/70">Anatómiailag hangolt úszóáram rendszer, amely segít a testet és lábakat vízszintesen tartani könnyebb úszásért.</p>
                    </div>
                    
                    <div className="glass-card rounded-2xl p-6 border border-blue-500/10">
                      <Dumbbell className="w-12 h-12 text-blue-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">Testreszabható edzések</h3>
                      <p className="text-white/70">Személyre szabott edzőprogramok a testípushoz és edzésstílushoz igazítva optimális eredményekért.</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="glass-card rounded-2xl p-6 border border-green-500/10">
                      ...
                      <h3 className="text-xl font-bold text-white mb-3">Fitnesz célok</h3>
                      <p className="text-white/70">Kardiovaszkuláris egészség javítása, súlykontroll, izomtónus fejlesztése és általános fitnesz növelése.</p>
                    </div>
                    
                    <div className="glass-card rounded-2xl p-6 border border-yellow-500/10">
                      <Crown className="w-12 h-12 text-yellow-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">Professzionális szint</h3>
                      <p className="text-white/70">Nem kell világklasszis úszónak lenni - az intelligens áramrendszer segít minden szinten.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeTab === 'family' && (
              <div className="animate-fade-in">
                <h2 className="text-3xl font-bold text-white mb-6">Családi szórakozás és biztonság</h2>
                <p className="text-white/80 mb-8">
                  Az S200 tökéletes az egész család számára értékes közös időtöltésre.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <div className="glass-card rounded-2xl p-6 border border-cyan-500/10">
                      ...
                      <h3 className="text-xl font-bold text-white mb-3">Splash Zone</h3>
                      <p className="text-white/70">Tágas játékterület, ahol az egész család együtt játszhat, fröcsköl és szórakozhat.</p>
                    </div>
                    
                    <div className="glass-card rounded-2xl p-6 border border-blue-500/10">
                      <ShieldCheck className="w-12 h-12 text-blue-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">Biztonsági funkciók</h3>
                      <p className="text-white/70">Többszintű ülések, beépített lépcsők, kapaszkodók és SwimDek® csúszásgátló burkolat.</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="glass-card rounded-2xl p-6 border border-green-500/10">
                      ...
                      <h3 className="text-xl font-bold text-white mb-3">Családi élmények</h3>
                      <p className="text-white/70">Úszásgyakorlás, vízi játékok, relaxáció és közös szórakozás egy helyen.</p>
                    </div>
                    
                    <div className="glass-card rounded-2xl p-6 border border-yellow-500/10">
                      <Maximize2 className="w-12 h-12 text-yellow-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">Tágas tér</h3>
                      <p className="text-white/70">Bőséges hely minden családtag számára egyszerre történő használatra.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-6">
                ...
                <h2 className="text-4xl font-bold text-white">
                  Készen áll a Swim Series™ élményre?
                </h2>
                <Dumbbell className="w-8 h-8 text-blue-400 ml-3 animate-pulse" />
              </div>
              
              <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
                Fedezze fel az S200 Swim Series™-t - úszás, fitnesz, terápia és családi szórakozás egyben!
              </p>
              ...
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                <button className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-8 py-4 rounded-full font-semibold hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Swim Spa Próba</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                </button>
                <button className="glass-button text-white px-8 py-4 rounded-full font-semibold hover:bg-white/20 transition-all duration-300 border border-white/30 hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Úszás Tesztelés</span>
