...
const A5LPage = () => {
  ...
  const product = products.find(p => p.name === 'A5L');
    ...
    <div className={`min-h-screen bg-gradient-to-br from-slate-900 via-navy-900 to-ocean-900 pt-20 pb-8 transition-all duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        {Array.from({ length: 12 }).map((_, i) => (
          <div
            key={i}
            className="absolute w-2 h-2 bg-gradient-to-r from-purple-400/25 to-pink-400/25 rounded-full animate-float"
            style={{
      ...
      {/* Custom cursor */}
      <div 
        className="fixed w-4 h-4 bg-gradient-to-r from-purple-400/60 to-pink-400/60 rounded-full pointer-events-none z-50 mix-blend-difference transition-transform duration-100"
        style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex items-center space-x-4 mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className="text-purple-400 font-semibold">Kompakt Luxus</span>
                </div>
              </div>
              <p className="text-xl text-white/80 mb-8 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                A legfunkciósabb kompakt spa - olyan kényelmes, mint a kétszer akkora spa-k.
              </p>
              
              {/* Quick Stats */}
              <div className="grid grid-cols-4 gap-4 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
                {[
                  { icon: Users, label: 'Személy', value: '2-3' },
                  { icon: Layout, label: 'Lounger', value: '1x' },
                  { icon: Zap, label: 'JetPak', value: product.jetpaks },
                  { icon: Compass, label: 'Beltéri/Külső', value: 'Igen' }
                ].map((stat, index) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className={`space-y-4 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            >
              ...
              <div className="absolute top-4 right-4 glass-button px-3 py-1 rounded-full bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-400/30">
                <span className="text-purple-300 text-sm font-semibold">A Series® Kompakt Champion</span>
              </div>
            </div>
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-900 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="glass-card rounded-2xl p-6 border border-purple-500/20">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-transparent bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text font-semibold">A Széria® Kompakt Luxus Champion</p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { label: 'Prémium JetPak® ülések', value: '2-3', icon: Zap },
            ...
            {/* Compact Luxury Features */}
            <div className="glass-card rounded-2xl p-6 border border-purple-500/20">
              <h3 className="text-white font-semibold mb-4 flex items-center">
                <Gem className="w-5 h-5 text-purple-400 mr-2" />
                Kompakt luxus előnyök
              </h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-purple-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Beltéri telepíthetőség</h4>
                    <p className="text-white/70 text-sm">Elég kicsi beltéri, terasz és erkély telepítéshez</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-pink-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Kétszer akkora élmény</h4>
                    <p className="text-white/70 text-sm">Olyan kényelmes és terápiás, mint a közel kétszer akkora spa-k</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Személyes terápia</h4>
                    <p className="text-white/70 text-sm">Tökéletes párok, üres fészkesek, egyedülállók számára</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Maximális funkciók</h4>
                    <p className="text-white/70 text-sm">A legfunkciósabb kompakt spa a piacon ma</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card rounded-2xl p-6 border border-purple-500/20">
              <h3 className="text-white font-semibold mb-4 flex items-center">
                ...
                Prémium lounger funkciók
              </h3>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-purple-400 rounded-full flex-shrink-0"></div>
                  <span className="text-white/80">Masszírozó csukló jet-ek</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-pink-400 rounded-full flex-shrink-0"></div>
                  <span className="text-white/80">Combhajlító jet-ek</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-3 h-3 bg-blue-400 rounded-full flex-shrink-0"></div>
                  <span className="text-white/80">Lábikra jet-ek</span>
                </div>
              </div>
            </div>
                ...
                {product.trimLevels?.map((trim, index) => (
                  ...
                  >
                    ...
                    <div className="text-sm mt-1">
                      {index === 0 && '3 JetPak®, 3-funkciós vezérlők, prémium világítás'}
                      {index === 1 && '2 JetPak®, Luxury Package kibővített funkciókkal'}
                      {index === 2 && '2 JetPak®, alap szint kiváló ár-érték aránnyal'}
                    </div>
                  </button>
                ))}
              </div>
            ...
            <div className="glass-card rounded-2xl p-6 border border-purple-500/20">
              ...
              <div className="space-y-3">
                {[
                  { label: 'Jelenlegi nézők', value: '67', trend: '+25' },
                  { label: 'Mai ajánlatkérések', value: '45', trend: '+22' },
                  { label: 'Foglalt bemutóterem látogatások', value: '38', trend: '+19' }
                ].map((stat, index) => (
...
<div className="mb-8 glass-card p-2 max-w-3x1 mx-auto border border-purple-500/20 rounded-xl md:rounded-full flex flex-wrap md:flex-nowrap gap-1">
          ...
          <div className="glass-card rounded-3xl p-8 border border-purple-500/20">
              ...
              <div className="animate-fade-in">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {product.jetPakOptions?.map((jetPak, index) => (
                    <div 
                      key={index} 
                      className="glass-card rounded-2xl p-6 hover:bg-white/10 transition-all duration-300 cursor-pointer group hover:scale-105 border border-purple-500/10"
                      onClick={() => setSelectedJetPak(index)}
                    >
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-xl font-bold text-white group-hover:text-purple-400 transition-colors">{jetPak.name}</h3>
                        ...
                        <div className="mt-3">
                          ...
                          <div className="flex flex-wrap gap-2 mt-2">
                            {jetPak.targetAreas.map((area, i) => (
                              <span key={i} className="bg-purple-500/20 text-purple-300 px-2 py-1 rounded-full text-xs border border-purple-400/30">
                                {area}
                              </span>
                            ))}
                          </div>
            ...
            {activeTab === 'features' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Prémium funkciók a tökéletes spa élményért minden A Series® szinten, különös hangsúllyal a kompakt luxusra és univerzális telepíthetőségre.
                </p>
            ...
            {activeTab === 'trims' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Az A5L három különböző szinten elérhető, mindegyik egyedi funkciókkal és testreszabási lehetőségekkel.
                </p>
                  ...
                  {product.trimLevels?.map((trim, index) => (
                    ...
                    >
                      <div className="text-center">
                        ...
                        <div className="space-y-3 text-left">
                          {index === 0 && (
                            <>
                              <div className="flex items-center space-x-2">
                                ...
                                <span className="text-white/70">3 JetPak® ülés</span>
                              </div>
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                          ...
                          {index === 1 && (
                            <>
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                                <span className="text-white/70">2 JetPak® ülés</span>
                              </div>
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                              ...
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                                <span className="text-white/70">2-funkciós vezérlők</span>
                              </div>
                            </>
                          )}
                          {index === 2 && (
                            <>
                              ...
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                                <span className="text-white/70">Kompakt optimalizálás</span>
                              </div>
                              <div className="flex items-center space-x-2">
                                <CheckCircle className="w-4 h-4 text-green-400" />
                        ...
                        <button className="w-full mt-4 bg-gradient-to-r from-purple-500/20 to-pink-500/20 text-white py-2 rounded-lg font-semibold hover:from-purple-500/30 hover:to-pink-500/30 transition-all duration-300 border border-purple-400/30">
        ...
        <div className="text-center">
          <div className="glass-card rounded-3xl p-12 relative overflow-hidden group border border-purple-500/20">
            {/* Animated background */}
            <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 via-pink-500/10 to-navy-500/10 animate-gradient-shift"></div>
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000">
              <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 via-pink-500/20 to-navy-500/20"></div>
            </div>
            
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-6">
                <Gem className="w-8 h-8 text-purple-400 mr-3 animate-pulse" />
                <h2 className="text-4xl font-bold text-white">
                  Készen áll a kompakt luxus élményre?
                </h2>
                <Package className="w-8 h-8 text-pink-400 ml-3 animate-pulse" />
              </div>
              
              <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
                Tapasztalja meg az A5L kompakt luxusát - a legfunkciósabb kis spa a piacon!
              </p>
              ...
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                <button className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-4 rounded-full font-semibold hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Kompakt luxus ajánlat</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                </button>
                <button className="glass-button text-white px-8 py-4 rounded-full font-semibold hover:bg-white/20 transition-all duration-300 border border-white/30 hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Beltéri próba</span>
              ...
              <div className="flex items-center justify-center space-x-8 mt-8 text-white/60">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span>Kompakt luxus</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Compass className="w-5 h-5 text-pink-400" />
                  <span>Beltéri/Külső</span>
                </div>
              </div>
            </div>
          </div>
