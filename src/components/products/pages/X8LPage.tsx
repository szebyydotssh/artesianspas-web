...
const X8LPage = () => {
  ...
  const product = products.find(p => p.name === 'X8L');
  ...
  const tabs = [
    ...
    { id: 'lounger', label: 'Lounger', icon: Sofa }
  ];
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-slate-900 via-navy-900 to-ocean-900 pt-20 pb-8 transition-all duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative z-10 p-12">
            <div className="max-w-2xl">
              ...
              <div className="flex items-center space-x-4 mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="h-6 w-px bg-white/30"></div>
                <div className="flex items-center space-x-1">
                  <Sofa className="w-6 h-6 text-purple-400" />
                  <span className="text-purple-400 font-semibold">Lounger Spa</span>
                </div>
              </div>
              <p className="text-xl text-white/80 mb-8 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                Tágas, minőségi spa prémium lounger üléssel - különféle relaxációs típusok hidroterápiás élményhez megfizethető áron.
              </p>
              ...
              <div className="grid grid-cols-4 gap-4 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
                {[
                  ...
                  { icon: DollarSign, label: 'Ár-érték', value: 'TOP' },
          ...
          <div className={`space-y-4 transition-all duration-1000 delay-700 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            >
              ...
              <div className="absolute top-4 right-4 glass-button px-3 py-1 rounded-full bg-gradient-to-r from-purple-500/20 to-blue-500/20 border border-purple-400/30">
                <span className="text-purple-300 text-sm font-semibold">X Series® Lounger</span>
              </div>
            </div>
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-900 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            ...
            <div className="glass-card rounded-2xl p-6 border border-blue-500/20">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-transparent bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text font-semibold">X Széria® Lounger Spa</p>
                </div>
            ...
            <div className="glass-card rounded-2xl p-6 border border-purple-500/20">
              <h3 className="text-white font-semibold mb-4 flex items-center">
                <Sofa className="w-5 h-5 text-purple-400 mr-2" />
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="text-white font-semibold">Tágas lounger ülés</h4>
                    <p className="text-white/70 text-sm">Prémium lounger ülés teljes testhosszúságú relaxációhoz</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-blue-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Különféle relaxációs típusok</h4>
                    <p className="text-white/70 text-sm">Hidroterápiás élmény, amely megegyezik a prémium spa-kkal</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">Több prémium ülés</h4>
                    <p className="text-white/70 text-sm">További prémium spa ülések barátokkal és családdal való élvezéshez</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-3 h-3 bg-yellow-400 rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h4 className="text-white font-semibold">X Series™ érték</h4>
                    <p className="text-white/70 text-sm">Megfizethető áron prémium spa élmény</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                {product.trimLevels?.map((trim, index) => (
                  ...
                  >
                    ...
                    <div className="text-sm mt-1">
                      {index === 0 && 'Prémium szűrés, érintőképernyős vezérlők, prémium világítási csomag'}
                      {index === 1 && 'Alap szint kiváló ár-érték aránnyal és lounger funkcióval'}
                    </div>
                  </button>
                ))}
              </div>
            ...
            <div className="space-y-4">
              <button className="w-full bg-gradient-to-r from-purple-500 to-blue-500 text-white py-4 rounded-full font-semibold hover:from-purple-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
                <span className="relative z-10">Lounger Spa tervezése árazásért</span>
            ...
            <div className="glass-card rounded-2xl p-6 border border-blue-500/20">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { label: 'Mai ajánlatkérések', value: '16', trend: '+8' },
                  { label: 'Lounger érdeklődések', value: '12', trend: '+7' }
                ].map((stat, index) => (
        ...
        <div className="mb-16">
          <div className="flex space-x-1 mb-8 glass-card rounded-full p-2 max-w-3xl mx-auto border border-blue-500/20">
            {tabs.map((tab) => (
              <button
                key={tab.id}
          ...
          <div className="glass-card rounded-3xl p-8 border border-blue-500/20">
            ...
            {activeTab === 'lounger' && (
              <div className="animate-fade-in">
                <h2 className="text-3xl font-bold text-white mb-6">Prémium Lounger élmény</h2>
                <p className="text-white/80 mb-8">
                  Az X8L prémium lounger ülése a tökéletes relaxáció és hidroterápia kombinációját kínálja.
                </p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <div className="glass-card rounded-2xl p-6 border border-purple-500/10">
                      <Sofa className="w-12 h-12 text-purple-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">Teljes testhosszúságú relaxáció</h3>
                      <p className="text-white/70">A prémium lounger ülés lehetővé teszi a teljes kinyújtózást és relaxációt, miközben terápiás masszázst élvez.</p>
                    </div>
                    
                    <div className="glass-card rounded-2xl p-6 border border-blue-500/10">
                      <Waves className="w-12 h-12 text-blue-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">Hidroterápiás élmény</h3>
                      <p className="text-white/70">Különféle relaxációs típusok hidroterápiás élményhez, amely megegyezik a prémium spa-kkal.</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="glass-card rounded-2xl p-6 border border-green-500/10">
                      ...
                      <h3 className="text-xl font-bold text-white mb-3">Társasági élmény</h3>
                      <p className="text-white/70">Több prémium spa ülés barátokkal vagy családdal való élvezéshez a lounger mellett.</p>
                    </div>
                    
                    <div className="glass-card rounded-2xl p-6 border border-yellow-500/10">
                      <DollarSign className="w-12 h-12 text-yellow-400 mb-4" />
                      <h3 className="text-xl font-bold text-white mb-3">X Series™ érték</h3>
                      <p className="text-white/70">Megfizethető áron prémium lounger spa élmény az X Series™ vonalból.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeTab === 'trims' && (
              <div className="animate-fade-in">
                ...
                <p className="text-white/80 mb-8">
                  Az X8L két különböző szinten elérhető, mindegyik egyedi funkciókkal és lounger élménnyel.
                </p>
                  ...
                  {product.trimLevels?.map((trim, index) => (
                    ...
                    >
                      <div className="text-center">
                        ...
                        <button className="w-full mt-4 bg-gradient-to-r from-purple-500/20 to-blue-500/20 text-white py-2 rounded-lg font-semibold hover:from-purple-500/30 hover:to-blue-500/30 transition-all duration-300 border border-purple-400/30">
          ...
          <div className="glass-card rounded-3xl p-12 relative overflow-hidden group border border-blue-500/20">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-6">
                <Sofa className="w-8 h-8 text-purple-400 mr-3 animate-pulse" />
                <h2 className="text-4xl font-bold text-white">
                  Készen áll a lounger spa élményre?
                </h2>
                <Target className="w-8 h-8 text-blue-400 ml-3 animate-pulse" />
              </div>
              
              <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
                Tapasztalja meg az X8L prémium lounger spa élményét - tágas relaxáció és hidroterápia megfizethető X Series™ értéken!
              </p>
              ...
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                <button className="bg-gradient-to-r from-purple-500 to-blue-500 text-white px-8 py-4 rounded-full font-semibold hover:from-purple-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Lounger Spa Próba</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                </button>
                <button className="glass-button text-white px-8 py-4 rounded-full font-semibold hover:bg-white/20 transition-all duration-300 border border-white/30 hover:scale-105 relative overflow-hidden group">
                  <span className="relative z-10">Hidroterápia Tesztelés</span>
              ...
              <div className="flex items-center justify-center space-x-8 mt-8 text-white/60">
                ...
                <div className="flex items-center space-x-2">
                  <Sofa className="w-5 h-5 text-purple-400" />
