    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="glass-card rounded-3xl p-6 sm:p-8 md:p-12 shadow-2xl max-w-5xl mx-auto animate-scale-in">
          <h1 className="font-bold-italic text-white mb-4 sm:mb-6 leading-tight animate-fade-in">
            Minőség mindenek 
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-white/90 mb-6 sm:mb-8 leading-relaxed font-bold-italic animate-fade-in animate-delayed-2 px-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 animate-fade-in animate-delayed-3">
            <button className="w-full sm:w-auto bg-gradient-to-r from-navy-500 to-ocean-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold-italic text-base sm:text-lg hover:from-navy-600 hover:to-ocean-600 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 hover:scale-105 flex items-center justify-center space-x-2 animate-pulse-glow">
              <ShoppingBag className="w-5 h-5" />
              <span>Vásárlás most</span>
            </button>
            
            <button className="w-full sm:w-auto glass-button text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold-italic text-base sm:text-lg hover:bg-white/20 transition-all duration-300 border border-white/30 flex items-center justify-center space-x-2 hover:scale-105">
          ...
          <div className="mt-8 sm:mt-12 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 text-white">
            <div className="glass-card rounded-2xl p-4 sm:p-6 border border-white/20 hover-lift animate-fade-in">
              <div className="text-2xl sm:text-3xl font-bold-italic mb-2 text-ocean-300">100+</div>
              <div className="text-white/80 text-sm sm:text-base font-bold-italic">Prémium termékek</div>
            </div>
            <div className="glass-card rounded-2xl p-4 sm:p-6 border border-white/20 hover-lift animate-fade-in animate-delayed">
              <div className="text-2xl sm:text-3xl font-bold-italic mb-2 text-navy-300">100%</div>
              <div className="text-white/80 text-sm sm:text-base font-bold-italic">Eredetiség</div>
            </div>
            <div className="glass-card rounded-2xl p-4 sm:p-6 border border-white/20 hover-lift animate-fade-in animate-delayed-2">
              <div className="text-2xl sm:text-3xl font-bold-italic mb-2 text-ocean-300">5★</div>
              <div className="text-white/80 text-sm sm:text-base font-bold-italic">Vásárlói értékelés</div>
            </div>
          </div>
        </div>
