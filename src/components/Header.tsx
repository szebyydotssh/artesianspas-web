          ...
          <nav className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            {navItems.map((item, index) => (
              <a
                key={item.label}
                href={item.href}
                className={`font-medium transition-all duration-300 relative group animate-fade-in ${
                  isScrolled
            ...
            <div className="flex items-center space-x-3 ml-4">
              ...
              <button className="bg-gradient-to-r from-navy-600 to-ocean-600 text-white px-4 sm:px-6 py-2.5 rounded-full font-medium hover:from-navy-700 hover:to-ocean-700 transition-all duration-300 flex items-center space-x-2 shadow-lg hover:shadow-xl hover:scale-105 animate-pulse-glow">
            ...
            <div className="px-4 py-6 space-y-4">
              {navItems.map((item, index) => (
                <a
                  key={item.label}
                  href={item.href}
                  className="block text-white hover:text-ocean-300 font-medium py-3 px-4 rounded-xl hover:bg-white/10 transition-all duration-300 animate-fade-in"
                  style={{ animationDelay: `${index * 0.1}s` }}
              ...
              <div className="flex items-center space-x-4 pt-4 px-4">
                ...
                <button className="bg-gradient-to-r from-navy-600 to-ocean-600 text-white px-6 py-3 rounded-full font-medium hover:from-navy-700 hover:to-ocean-700 transition-all duration-300 flex items-center space-x-2 shadow-lg flex-1 justify-center">
                  <ShoppingBag className="w-4 h-4" />
                  <span>Tervezés</span>
                </button>
              </div>
